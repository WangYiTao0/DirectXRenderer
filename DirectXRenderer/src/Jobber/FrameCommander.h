...
#include "Jobber/Effect/BlurPack.h"
#include <array>
...
namespace dr
{
	...
	public:
		FrameCommander(Graphics& gfx)
			...
			blur(gfx, 7, 2.6f, ".\\asset\\shader\\cso\\BlurOutline_PS.cso")
		{
			...
			pVsFull = Bind::VertexShader::Resolve(gfx, ".\\asset\\shader\\cso\\Fullscreen_VS.cso");
