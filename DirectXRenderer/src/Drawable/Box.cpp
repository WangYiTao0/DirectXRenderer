...
namespace dr
{
		...
		phi(adist(rng))
	{
		...
		if (!IsStaticInitialized())
		{
			...
			auto pvs = std::make_unique<VertexShader>(gfx, L"./asset/shader/cso/Phong_vs.cso");
			auto pvsbc = pvs->GetBytecode();
			AddStaticBind(std::move(pvs));

			AddStaticBind(std::make_unique<PixelShader>(gfx, L"./asset/shader/cso/Phong_ps.cso"));
