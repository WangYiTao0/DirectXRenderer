	...
	std::unique_ptr<Mesh> Model::ParseMesh(Graphics& gfx, const aiMesh& mesh, const aiMaterial* const* pMaterials, const std::filesystem::path& path, float scale)
	{
		...
		if (hasDiffuseMap && hasNormalMap && hasSpecularMap)
		{
			...
			bindablePtrs.push_back(PixelShader::Resolve(gfx,
				hasAlphaDiffuse ? shader_dir + "PhongSpecNormMask_ps.cso" : shader_dir + "PhongSpecNormalMap_ps.cso"
			));
		...
		else if (hasDiffuseMap && !hasNormalMap && hasSpecularMap)
		{
			...
			bindablePtrs.push_back(PixelShader::Resolve(gfx, shader_dir + "PhongSpec_ps.cso"));
		...
		else if (hasDiffuseMap)
		{
			...
			bindablePtrs.push_back(PixelShader::Resolve(gfx, shader_dir + "Phong_ps.cso"));
		...
		else if (!hasDiffuseMap && !hasNormalMap && !hasSpecularMap)
		{
			...
			auto pvs = VertexShader::Resolve(gfx, shader_dir + "PhongNotex_vs.cso");
			auto pvsbc = pvs->GetBytecode();
			bindablePtrs.push_back(std::move(pvs));

			bindablePtrs.push_back(PixelShader::Resolve(gfx, shader_dir + "PhongNotex_ps.cso"));
