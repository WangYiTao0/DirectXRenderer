...
//	hit.t =
//t0;
//	hit.material_id = sphere.
//material;
//	hit.origin =
//impact;
//	hit.normal = (impact - sphere.origin) / sphere.
//radius;
//}
...
//	hit.material_id = p.
//material;
//	hit.origin = ray.origin + ray.direction *
//t;
...
//#else
//	return texture(iChannel0, (x.xy + vec2(3.0, 1.0)*x.z + 0.5) / 256.0, -100.0).
//xyz;
//#endif
//}
...
//lacunarity;
//	t+= 0.25584929 * noise(p); p *=
//lacunarity;
//	t+= 0.12527603 * noise(p); p *=
//lacunarity;
