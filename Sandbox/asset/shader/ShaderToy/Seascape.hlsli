...
vec3 getSeaColor(vec3 p, vec3 n, vec3 l, vec3 eye, vec3 dist)
{
    ...
    color += vec3(specular(n, l, eye, 60.0), specular(n, l, eye, 60.0), specular(n, l, eye, 60.0));
...
// main
void Seascape(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    // post
    fragColor = vec4(pow(color, vec3(0.65,0.65,0.65)), 0.5);
}