...
//    float a = iChannel0.SampleLevel(splr, (p + vec2(0.5, 0.5)) / 256.0, 0.0).x;
//    float b = iChannel0.SampleLevel(splr, (p + vec2(1.5, 0.5)) / 256.0, 0.0).x;
//    float c = iChannel0.SampleLevel(splr, (p + vec2(0.5, 1.5)) / 256.0, 0.0).x;
//    float d = iChannel0.SampleLevel(splr, (p + vec2(1.5, 1.5)) / 256.0, 0.0).x;
...
//    return iChannel0.Sample(splr, x * .01).x;
//}
//float fbm(in vec2 p)
//{
//    float z = .5;
